...
export const ITEMS_CONFIG: Record<ItemId, Item> = {
  ...
  plungerHat: {
    id: "plungerHat",
    name: "Plunger Hat",
    baseStats: { stamina: 15, attack: 15, defense: 15, speed: 4, crit: 3 },
    rarity: "legendary",
    slot: "hat",
  },
